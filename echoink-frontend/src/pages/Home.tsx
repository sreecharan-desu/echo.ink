            ...
            <div className="grid gap-6">
                {loading
                    ...
                    : posts.map((post: Post) => (
                          <div
                              key={post.id}
                              className="bg-white border border-gray-200 rounded-lg shadow-sm p-10 transition-all duration-500 ease-in-out transform hover:shadow-lg hover:scale-105"
                          >
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                                  <div className="flex-1">
                                      ...
                                      <div className="flex items-center space-x-4">
                                          <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center overflow-hidden transition duration-300 ease-in-out">
                                  ...
                                  <div className="mt-4 sm:mt-0 sm:ml-6">
                                      {post.image_link ? (
                                          <img
                                              src={post.image_link}
                                              alt="Post"
                                              className="w-32 h-32 rounded-lg object-cover border border-gray-200 shadow-sm transition duration-300 ease-in-out hover:shadow-lg"
                                          />
                                      ) : (
